...
vim.keymap.set("n", "<leader>gs", "<CMD>Gedit :<CR>", { silent = true })
vim.keymap.set("n", "<leader>gb", "<CMD>tab Git blame<CR>", { silent = true })
vim.keymap.set("n", "<leader>gp", "<CMD>Git pull --ff<CR>", { silent = true })
